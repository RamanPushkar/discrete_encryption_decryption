...
print("~~","                                                     ~~")
print("~~                                            ","         ~~")
print("~~        ",colored('Welcome to Decryption Technology PART 2', 'green', 'on_red'),Back.BLACK+Fore.RED +"            ~~")
print("~~                                            ","         ~~")
print("~~","                                                     ~~")
print("~~  "*15)
#______________________________________________________________________________________________________________________
...
print("Derived Data List with Splitting at 2 :",list([derived_data_str[i:i + 2] for i in range(0, len(derived_data_str), 2)]))
derived_data_str_sp_at_2=list([derived_data_str[i:i + 2] for i in range(0, len(derived_data_str), 2)])
